...
@mcp.tool()
def queryCompanyInfo() -> dict:
    """ 在咨询公司信息、品牌信息、企业简介、企业优势、认证资质或市场布局时，请始终使用此工具来查询公司相关信息。"""
    result = {
      "公司名称": "Chongqing Rob Linka Science And Technology Co., Ltd.",
      "公司名称（中文）": "重庆罗布林卡科技有限公司",
      "品牌名称": "DOMAS",
      "公司简介": "Chongqing Rob Linka Science And Technology Co., Ltd. 是一家专注于健康护理与智能理疗设备研发、生产和销售的专业制造商，拥有超过7年行业经验。公司致力于为全球客户提供高品质产品、专业服务及创新健康解决方案。公司总部位于中国重庆市北碚区两江健康科技城，拥有现代化生产基地，厂房面积超过4000平方米，员工人数超过40人。旗下品牌DOMAS专注于家庭健康护理、理疗康复、美容护理及肌肉训练领域，持续推动产品创新与智能化升级。",
      "品牌简介": "DOMAS拥有专业的研发与设计团队，专注于为全球消费者提供高品质健康科技产品。品牌核心理念是科技改善健康生活、创新提升用户体验、品质赢得全球市场。产品覆盖理疗设备、美容仪器、肌肉刺激设备及家庭健康护理用品，深受海外市场欢迎。",
      "主营产品": {
        "理疗康复系列": [
          "TENS神经电刺激理疗仪",
          "EMS肌肉刺激训练仪",
      ...
      "企业优势": [
        {
          "标题": "自主研发能力强",
          "内容": "公司拥有专业研发团队，具备产品结构设计、电子研发、软件开发及外观设计能力，并拥有多项自主知识产权与专利技术。"
        },
        {
          "标题": "OEM / ODM定制服务",
          "内容": [
        ...
        {
          "标题": "现代化生产体系",
          "内容": "公司建立了标准化、规模化生产体系，具备稳定交付能力，可满足大批量订单需求。"
        },
        {
          "标题": "严格质量管理",
          "内容": "拥有科学严谨的质量检验体系，从原材料采购到成品出货全流程严格把控。"
        }
      ],
      "国际认证资质": [
      ...
      "企业使命": "通过科技创新，让全球用户享受更安全、更便捷、更高效的健康护理产品。",
      "企业愿景": "成为全球领先的家庭健康科技品牌与智能理疗设备供应商。"
    }
    return {"success": 0, "result": result}
